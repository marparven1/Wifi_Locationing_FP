...
Dat_EntrenamientoIV$MaxSenal <- apply( Dat_EntrenamientoIV[, 1:411], 1, function(x)
  max(x))
Dat_EntrenamientoIV$MinSenal <- apply( Dat_EntrenamientoIV[, 1:411], 1, function(x)
  min(x[x > 0-120]))
Dat_EntrenamientoIV$NumWAP_Detectados <- apply( Dat_EntrenamientoIV[, 1:411], 1, function(x)
  sum(x > -120))
```
...
- Número de columnas `r dim(Dat_EntrenamientoIV)[2]` de las cuales 411 corresponden a la intensidad de señal detectada
